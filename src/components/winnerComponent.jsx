		...
		<>
			...
			<div ref={winnerCardRef} className="pt-[5rem] text-white pb-[10rem] bg">
				<div className="flex justify-center">
					<h1 className="text-[3rem] font-bold">{ritual.nombre}</h1>
				</div>
				<div className="p-8 text-white space-y-8">
					...
					<div className="text-[2.5rem]">
						...
						<div className="grid grid-cols-[repeat(auto-fit,minmax(150px,1fr))] gap-4 animate-shadow-inset-center rounded-lg bg-white p-4">
